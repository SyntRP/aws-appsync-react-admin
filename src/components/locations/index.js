...
const Locations = () => {
  ...
  useEffect(() => {
    if (!loading && !error) setSurveyLocations(data?.listSurveyLocations?.items);
  }, [loading]);
  ...
  // console.log("DK:", data);
  // console.log("locations:", surveyLocations);

  return ( 
    <>
    {/* <div>
      <Breadcrumbs aria-label="breadcrumb">
        <Typography color="primary">Survey Locations</Typography>
      </Breadcrumbs>
    </div> */}
    <div>
      {/* <Box display="flex">
